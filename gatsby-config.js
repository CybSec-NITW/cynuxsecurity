...
require('./config/prismjs/cynuxsecurity')
...
const title = 'Cynux Security'
const description =
  'Cynux is an open source project that is maintained and ' +
  'funded by CybSec NITW & Bugclaim, a provider of worldclass information' +
  'security training and penetration testing services.'
...
const plugins = [
  ...
  'gatsby-plugin-catch-links',
  {
    ...
    options: {
      ...
      name: 'cynuxsecurity.org',
      short_name: 'cynuxsecurity.org',
      start_url: '/',
      theme_color: '#eff4f8'
...
if (process.env.GITHUB_TOKEN) {
  plugins.push({
    ...
    options: {
      ...
      graphQLQuery: `
          {
            repository(owner: "CybSec-NITW", name: "cynuxsecurity") {
              stargazers {
                totalCount
              }
            }
...
module.exports = {
  ...
  siteMetadata: {
    description,
    keywords,
    siteUrl: 'https://cynuxsecurity.org',
    title
  },
