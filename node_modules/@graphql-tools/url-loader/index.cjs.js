...
class UrlLoader {
    ...
    async createFormDataFromVariables({ query, variables }) {
        ...
        const { clone, files } = extractFiles.extractFiles(vars, 'variables', ((v) => typeof v === 'object' &&
            (extractFiles.isExtractableFile(v) || v instanceof Upload || Symbol.asyncIterator in v || isPromise(v))));
