...
exports.pluginOptionsSchema = function (_ref) {
  ...
  return Joi.object({
    ...
    tracedSVG: Joi.boolean().default(false).description("Use traced SVGs for placeholder images instead of the \u201Cblur up\u201D effect. Pass true for traced SVGs with the default settings (seen here), or an object of options to override the default. For example, pass { color: \"#F00\", turnPolicy: \"TURNPOLICY_MAJORITY\" } to change the color of the trace to red and the turn policy to TURNPOLICY_MAJORITY. See node-potrace parameter documentation for a full listing and explanation of the available options."),
