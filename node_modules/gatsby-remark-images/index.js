...
module.exports = function (_ref, pluginOptions) {
  ...
  var generateImagesAndUpdateNode = /*#__PURE__*/function () {
    var _ref4 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(node, resolve, inLink, overWrites) {
      var parentNode, imagePath, imageNode, fluidResult, originalImg, fallbackSrc, srcSet, presentationWidth, srcSplit, fileName, fileNameNoExt, defaultAlt, isEmptyAlt, alt, title, loading, imageStyle, imageTag, webpFluidResult, placeholderImageData, args, _require4, Potrace, argsKeys, tracedSVG, ratio, wrapperStyle, imageCaption, removeBgImage, imageStats, bgImage, rawHTML;
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 15:
              ...
              return fluid({
                ...
                options.withWebp === true ? {} : options.withWebp, options),
                reporter: reporter
              });

            case 33:
              webpFluidResult = _context2.sent;
            ...
            case 47:
              ...
              _context2.t0 = options.showCaptions;
