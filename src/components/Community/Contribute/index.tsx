      ...
      >
        <div className={sharedStyles.items}>
          <div className={sharedStyles.item}>
            ...
            >
              Let&apos;s build something great together. Become a Cynux
              contributor!.
            </CommunityBlock>
          </div>
          <div className={sharedStyles.item}>
            <CommunityBlock
              ...
              action={
                <Link
                  className={sharedStyles.button}
                  style={theme}
                  href="mailto:info@cynuxsecurity.org?subject=I want to write a blogpost!"
                  target="_blank"
                  onClick={logBlogpost}
                >
                  Let’s talk!
            ...
            <CommunityBlock
              ...
              action={
                <Link
                  className={sharedStyles.button}
                  style={theme}
                  href="mailto:info@cynuxsecurity.org?subject=I want to give a talk!"
                  target="_blank"
                  onClick={logTalk}
                >
                  Let’s talk!
