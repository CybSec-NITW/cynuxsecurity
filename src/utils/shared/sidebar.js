...
function cynuxsecurityTitleCase(slug) {
  return titleCase(slug.replace(/cynuxsecurity/g, 'cynuxsecurity').replace(/-/g, ' '))
}
  ...
  switch (type) {
    ...
    default:
      ...
      return {
        ...
        label: label ? label : cynuxsecurityTitleCase(slug),
        tutorials: tutorials || {},
        prev,
        next: undefined,
        ...sharedFields
